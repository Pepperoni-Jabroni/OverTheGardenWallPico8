  ...
  elseif act_item==4 then
    ...
    if mget(x,y)==110 then 
      ...
      if digcount==4 then 
        ...
        act_y-=1
        act_item=nil
        get_npc_by_charid('e').idle={'what a wonderful harvest'}
      end
    end
  end
 else
