...
version 41
__lua__
local ei,n𝘸,n𝘣,n𝘱,n𝘭,n𝘲,nq,nx,t,n𝘤,n𝘢,n𝘳,n_,n𝘵,n𝘧,nv,n𝘨,n𝘥,nj,n𝘩,n𝘫,n𝘻,n𝘴,n𝘶,n𝘬,n𝘺,n𝘦,nz,n𝘪,n𝘹,n𝘰=split"43,110,158,185,106,190,191,202,203,205,207,222,223,238,239,240,241,242,244,245,246,247,248,249",{},(function()local e={}for n in all(split("255,candy,g#214,bird art,g#252,pumpkin shoe,g;w#253,shovel,g;w;b#254,old cat,g;k;y#126,instruments,g","#"))do local n=split(n)add(e,{spridx=n[1],name=n[2],charids=split(n[3],";")})end return e end)(),false,nil,nil,{},0,0,nil,nil,false,{},"boot",1,nil,{},{},{},{},{},{},0,0,0,0,0,{},{}local n𝘷,en,n𝘮,n𝘺,ee,ea,eo={function()return w"woods1,right_of,8"end,function()n"5"end,function()return 𝘥(1,"woods1")and(nx~=8or t~=8)end,function()n"6"end,function()return 𝘥(1,"woods1",13,7)end,function()n"18"end,function()return 𝘥(1,"woods2")end,function()end,function()return p(5,7,"woods2")end,function()n"3"𝘯()end,function()return k"woods2,m"end,function()n"4"end,function()return d"4"end,function()r"m,15|0|7|7"end,function()return#nj==2and w"woods3,below,13"end,function()n"7"end,function()return p(7,10,"woods3")end,function()n"8"end,function()return d"8"end,function()f(s{"b",nv,7,10},true)end,function()return k"millandriver,m"end,function()n"9"end,function()return d"9"end,function()r"m,7|3|7|11"end,function()return nv=="mill"and#nj==2end,function()n𝘭=nil r"m,7|4"𝘧"k"local e=e"k"e.mapid,e.x,e.y="millandriver",12,12l"millandriver".discvrdtiles={}f"?,millandriver,13,13"n"16"c"214,mill,2,12"end,function()return k"millandriver,?"end,function()n"12"local n=l(nv).discvrdtiles add(n,"12|6")add(n,"12|7")add(n,"13|6")add(n,"13|7")end,function()return nv=="home"end,function()n"10"end,function()return k"woods1,t"end,function()n"11"end,function()return d"12"end,function()e"?".intent="chase_candy_and_player"𝘭"k"end,function()local n=e"?"return w"mill,above,0"and n~=nil and n.mapid=="mill"end,function()𝘭"w"l"mill".playmapspr=124n"20"end,function()return w"woods1,left_of,1"end,function()n"14"end,function()return w"mill,left_of,7"end,function()n"13"end,function()return p(2,12,"mill")end,function()v"2"𝘨"214"n"17"end,function()return d"19"end,function()v"1"𝘧"w"r"w,2|9"end,function()local n=e"?"return p(1,4,"mill")and n~=nil and n.mapid=="mill"end,function()𝘵("millandriver",7,4)del(nz,e"?")del(nz,e"m")f"d,millandriver,5,4|t,millandriver,5,5|m,millandriver,6,5"n"22"m"you completed act 1!"n𝘭=nil end,function()return nv=="woods3"end,function()end,function()local n=l(nv)return nv=="woods3"and mget(n.cellx+nx,n.celly+t)==158end,function()n"23"v"3"end,function()local n=l"home"return nv=="pottsfield"and u(n.playmaplocx,n.playmaplocy)<3end,function()n"24"end,function()return k"barn,o"end,function()n"25"end,function()return k"barn,e"end,function()n"26"n𝘭=nil r"e,7|13|7|5,o,7|13|6|5,o,7|13|5|6,o,7|13|7|7,i,7|13|9|5,i,7|13|10|6"end,function()return 𝘱("pottsfield",174)and 𝘩()end,function()𝘲"190"n𝘴+=1if(n𝘴<5)del(n𝘪,29)
𝘳()end,function()return 𝘱("pottsfield",158)and 𝘩()end,function()𝘲"190"n𝘶+=1if(n𝘶<5)del(n𝘪,30)
𝘳()end,function()return 𝘩()and nv=="pottsfield"end,function()n"27"end,function()return n𝘬==4end,function()n𝘭=nil n"44"r"o,8|10"end,function()return w"school,below,13"end,function()n"29"𝘧"w,b"𝘭"y"r"w,5|11,b,4|11"end,function()return nv=="grounds"and#nj==2end,function()n"30"end,function()if(not x(34))return false
...
n.cldwn+=1del(n𝘪,36)end,function()local e,n=𝘤()return n==0end,function()local o,l=𝘤()n𝘦+=1if(n𝘦<2)i"haha yeah we got one!"v"5"del(n𝘪,37)else n"31"local n,o=𝘫(nv,nx,t)f(s{"l",nv,n,o})e"l".intent="chase_candy_and_player"
del(nq,o)end,function()return n𝘦>1and nv=="school"end,function()n"32"del(nz,e"l")n𝘭=nil 𝘧"y,k"r"r,3|5,w,6|5,b,8|5,u,6|2,c,7|2,y,12|5,k,5|5"end,function()return x(38)and w"school,below,6"end,function()n"33"end,function()local n=e"r"return x(39)and u(n.x,n.y)<=1end,function()n"34"end,function()return d"34"end,function()n"35"music"17"end,function()return d"35"end,function()n"36"c"126,school,6,2"c"126,school,7,2"end,function()return d"36"end,function()n"37"f"𝘤,school,7,6"r"𝘤,7|14|11|4,r,7|9"music"-1"𝘨"126"c"126,grounds,10,4"end,function()local n=e"𝘤"return n~=nil and n.mapid=="grounds"end,function()n"38"end,function()local n=e"𝘤"return n~=nil and n.intent==nil and k"grounds,𝘤"end,function()n"39"end,function()return d"39"end,function()n"40"e"𝘤".flipv=true end,function()return x(46)and p(10,4,"grounds")end,function()v"6"i"we got em!"𝘨"126"end,function()return n𝘭==6and nv=="school"end,function()n𝘭=nil n"41"r"r,7|14|13|10,c,7|14|12|9,u,7|14|11|9,y,7|14|10|10,𝘤,11|11"e"𝘤".flipv=false 𝘭"k"𝘭"w"𝘭"b"end,function()return x(48)and w"grounds,above,8"end,function()f"l,grounds,11,4"e"l".intent="chase_candy_and_player"end,function()local n=e"l"return x(49)and u(n.x,n.y)<1end,function()n"42"local n,o=e"l",e"r"f(s{"j,grounds",n.x,n.y-1})𝘬(e"j","13|11")del(nz,n)end,function()local n=e"j"return n~=nil and n.x==13and n.y==11and u(n.x,n.y)<3end,function()c"126,grounds,12,9"c"126,grounds,11,9"c"126,grounds,10,10"n"43"music"23"m"you completed act 3!"end,function()return nv=="secret"end,function()m"you found the secret room!"local n=1for e in all(n𝘩)do if(e.mapspridx~=nil)c(s{e.mapspridx,"secret",(n*2+1)%10+3,ceil(n/5)*2+1})n+=1
end end,function()local n=e"o"return s{n.mapid,n.x,n.y}=="pottsfield,8,10"end,function()n"45"local n=e"s"f(s{"p,pottsfield",n.x,n.y})m"you completed act 2!"del(nz,n)end,function()return w"woods5,left_of,1"end,function()i"the road ends here for now"i"ᶜ9thanks for playing!"end},split("|woods1,leave a trail of candy|woods1,give the turtle a candy|woods2,leave a trail of candy|woods2,inspect the strange tree|woods2,meet someone new|||woods3,search the bushes||millandriver,talk with the woodsman||millandriver,enter the mill|millandriver,find the frog!|pottsfield,visit the home|woods1,spot the turtle||millandriver,run back to your brother!|||mill,find a club|mill,use the club!|mill,jump the window to escape!,14||woods3,acquire new shoes||pottsfield,meet the residents|barn,meet the host|pottsfield,collect wheat,28|pottsfield,collect pumpkin,28||pottsfield,dig at the flower,31|school,start the lesson|grounds,go play outside,33|grounds,play 2 old cat,34|||school,run back to school!,37|school,cheer folks up,38|school,talk to the teacher,39|||||||grounds,grab the instruments!,46|school,talk with ms langtree,47||grounds,confront the gorilla,48||||","|"),{},{},{function()nr()end,function()n0()end,function()n1()end,function()nf()end,function()ns()end,function()nc()end,function()nu()end,function()nh()end,function()n2()end,function()n4()end,function()nw()end,function()ng()end},"128#129#130#131#132#132,true#131,true#130,true#129,true#128,true#144#0#133#134#135#136#137#145#0#144,true#144#0#146#147#148#149#150#151#0#144,true#144#0#152#153#160#161#162#163#0#144,true#144#0#0#164#165#166#167#0#0#144,true#168#169#176#176#176#176#176#176#169,true#168,true",split"kitty,wirt,wirt jr.,george washington,mr. president,benjamin franklin,doctor cucumber,greg jr.,skipper,ronald,jason funderburker"function o(n,e)for n in all(n)do if(e==n)return true
end return false end function h(n,e,o)if(n)return e
return o end n𝘩=(function()local o={}for n in all(split("g;greg;0;2;where is that frog o' mine!|wanna hear a rock fact?#w;wirt;1;4;uh, hi...|oh sorry, just thinking#b;beatrice;16;6;yes, i can talk...|lets get out of here!#k;;17;8;ribbit#a;the beast;32;34#m;the woodsman;33;36;i need more oil|beware these woods#?;the beast?;48;38;*glares at you*;2#d;dog;49;40;*barks*#t;black turtle;64;66;*stares blankly*#z;turkey;65;68;gobble. gobble. gobble.#o;pottsfield citizen 1;80;98;you're too early#i;pottsfield citizen 2;80;102;are you new here?#s;skeleton;81;70;thanks for digging me up!#p;partier;96;100;let's celebrate!#e;enoch;97;72;you don't look like you belong here;2#u;dog student;10;44;humph...|huh...#l;gorilla;113;12;*roaaar*!#j;jimmy brown;11;14#c;cat student;26;46;humph...|huh...#r;ms langtree;112;104;oh that jimmy brown|i miss him so...#n;the lantern;;76#𝘧;rock fact;215;78#𝘦;edelwood;219;192#y;racoon student;27;194;humph...|huh...#𝘢;achievement get!;;196#𝘤;mr langtree;184;182;these poor animals","#"))do local n=split(n,";")local e=n[3]e=h(e=="",nil,tonum(e))add(o,{id=n[1],name=n[2],mapspridx=e,chrsprdailogueidx=tonum(n[4]),idle=h(#n>4,split(n[5],"|"),"huh?"),scaling=h(#n>5,tonum(n[6]),1)})end return o end)()function y(e)for n in all(n𝘩)do if(n.id==e)return n
...
add(e[t],{speakerid=n[1],text=o,large=h(#n>2,n[3]=="𝘭",false)})end t+=1end return e end)()function _init()palt(0,false)repeat local n=z(𝘶())if(not o(n𝘮,n))add(n𝘮,n)
until#n𝘮==4y"k".name=eo[z(eo)]end function _update()𝘷(n𝘵).update()end function _draw()𝘷(n𝘵).draw()end function n1()if(btn"5")n𝘵="mainmenu"
...
local n=n[z(n)]return n[1],n[2]end function f(n,e)for n in all(split(n,"|"))do n=split(n)add(h(e or false,nj,nz),{charid=n[1],mapid=n[2],x=n[3],y=n[4]})end end function c(n)n=split(n)add(nq,{spridx=n[1],mapid=n[2],x=n[3],y=n[4],cldwn=1})end function 𝘨(e)for n in all(nq)do if(n.spridx==tonum(e))del(nq,n)
...
local w,g=1for n in all(en)do local n=split(n)if(n[1]==nv and not o(n𝘪,w)and x(h(#n>2,n[3],nil)))g=n[2]break
w+=1end local w,b,k=nn(nv,nx,t)if w~=nil and not n𝘱 then n𝘱=true if 𝘴(w)<𝘴(nv)then 𝘵(w,b,k)elseif g~=nil then if(a==0)i"we aren't done here yet... we should"i("ᶜ9["..g.."]")
else 𝘵(w,b,k)end elseif w==nil then n𝘱=false end if btnp(5)and n𝘭~=nil and o(n𝘣[n𝘭].charids,n𝘤)and not r then sfx(0)n𝘲=n𝘭 if n𝘭==1then c(s{"255",nv,nx,t})elseif n𝘭==2then local e=e"m"if(u(e.x,e.y)<2and not d"19")n"19"e.flipv=true
...
for n in all(n𝘺)do m(n)end i(#n𝘺.." of 7 achievements gotten!")end)function x(n)return n==nil or o(n𝘪,n)or false end function 𝘯()if(not o(n𝘨,nv))add(n𝘨,nv)
i("*eerily howls in the cool fall wind*","𝘦",true)i(#n𝘨.." of 7 edelwoods found!","𝘦")if(#n𝘨==7)m"you found all 7 edelwoods!"
...
end end end return nil,nil,nil end function 𝘩()return e"e".mapid=="pottsfield"end function 𝘳()if(n𝘴>4and n𝘶>4)n"28"v"4"
...
end end end local e,t,l=nn(i,n.x,n.y)if(not o and e~=nil)n8(n,e,t,l)
...
end end function 𝘹()f(s{n𝘤,nv,nx,t},true)n𝘤=nj[1].charid nx=nj[1].x t=nj[1].y nj=𝘸(nj)end local i,s,f,c=0,"pepjebs","studios",{}function nr()if(i%5==0and flr(i/5)<=#s)local n=flr(i/5)+1nb=sub(s,n,n)add(c,{letter=nb,x=10+12*n,y=45,age=0})
i+=1if(i>220)n𝘵="scene"pal(13,132,1)music"23"
end function n0()cls(7)if i==1then sfx(3)elseif i==135then sfx(4)end local n,e,o=58,72,1if i<60then o=7elseif i<120then o=6end print("⁶i"..f,n-#f,e,o)if(i>130and i<160)line(n-#f+(i-135),e-8,n-#f+(i-130)+4,e+16,7)line(n-#f+(i-135)+1,e-8,n-#f+(i-130)+5,e+16,7)
...
end end function nh()cls(0)print("ᶜa⬆️⬇️⬅️➡️ᶜ7 move",16,20)print("ᶜa❎ᶜ7 progress dialog or\n use item",16,40)print("ᶜa🅾️ᶜ7 switch characters",16,60)print("ᶜa❎+⬆️⬇️⬅️➡️ᶜ7 select object\n or npc",16,80)print("ᶜa🅾️ᶜ7 back to menu",8,118)end function nc()cls(0)local l,i,o=16,4,split(ea,"#")for n=1,6do for e=1,10do local o,t=split(o[(n-1)*10+e]),false if(#o>1)t=true
if(o[1]~=0)spr(o[1],l+e*8,i+n*8,1,1,t,false)else rectfill(l+e*8,i+n*8,l+e*8+8,i+n*8+8,o[1])
end end 𝘮("start",48,65,t==0)𝘮("controls",42,85,t==1)𝘮("quit",50,105,t==2)local n=65+t*20palt(5,true)pal(12,9)spr(234,24,n,1,1)spr(234,96,n,1,1,true,false)pal(12,12)palt(5,false)np=𝘶()local n={{x=4,y=4},{x=108,y=4},{x=4,y=108},{x=108,y=108}}for e=1,#n do g(n[e].x,n[e].y,17,17,2,10,9)spr(np[n𝘮[e]].chrsprdailogueidx,n[e].x+1,n[e].y+1,2,2)end end function n4()local n,e=32,16cls(0)g(n,e,66,52,0,4,5)sspr(80,72,32,24,n+1,e+4,64,48)nt()end function nt()if#n_>0then local n=q()[n𝘧]if(n~=nil)n7(n)
...
𝘺(0,y(n𝘤).mapspridx,nx,t,1,n𝘳,false)for n in all(𝘰(nv))do if n.x~=nil and n.y~=nil then local e,t=y(n.charid),1if(e.scaling~=nil)t=e.scaling
local o=false if(n.flipv)o=true
local l=false if(nx<n.x and not o)l=true
𝘺(0,e.mapspridx,n.x,n.y,t,l,o)end end for n in all(nq)do local e,o=n.x,n.y local t=h(𝘪(n.mapid,e,o),0,-.5)if(n.mapid==nv)𝘺(0,n.spridx,e+t,o,1,false,false)
...
pset(n+2,o+4,t)pset(n+5,o+4,t)end e.frmcnt-=1else del(n𝘫,e)end end local e,n=n𝘭~=nil and o(n𝘣[n𝘭].charids,n𝘤),nil if n𝘰~=nil and n𝘰.frmcnt>0then n=n𝘰.txt n𝘰.frmcnt-=1else end ni(1,y(n𝘤).mapspridx,n)if(e)local e=n𝘣[n𝘭]ni(114,e.spridx,h(n~=nil,e.name,nil))
a=n𝘹 if(a~=nil and a.frmcnt>0)g(a.x,a.y,#a.txt*4+4,8,4,10,9)b(a.txt,a.x+3,a.y+3,2)b(a.txt,a.x+2,a.y+2,9)a.frmcnt=a.frmcnt-1
palt(13,false)nt()end function ni(e,l,o)local n,t=1,u(1,e/8)<3if(t)n=114
if o~=nil then if(t)n=90
g(n,e,#o*4+12,11,4,10,9)b(o,n+12,e+5,2)b(o,n+11,e+4,9)else g(n,e,11,11,4,10,9)end spr(l,n+2,e+2)end function 𝘺(r,a,o,t,n,l,i,e)e=e or 8local a,d=a%16*8,a\16*8for n=0,15do pal(n,r)end n=n or 1n*=e sspr(a,d,e,e,o*8,t*8+1,n,n,l,i)sspr(a,d,e,e,o*8+1,t*8,n,n,l,i)sspr(a,d,e,e,o*8+1,t*8+1,n,n,l,i)for n=0,15do pal(n,n)end sspr(a,d,e,e,o*8,t*8,n,n,l,i)end function e(e)for n in all(𝘦())do if(n.charid==e)return n
end end function q()local n=n_[1]if(type(n)=="number")n=el[n]
return n end function w(n)local n=split(n)if(n[1]~=nv)return false
...
end return true end function p(n,e,o)local l,i,a=𝘣(n𝘢)return l~=nil and o==nv and nx+i==n and t+a==e end function 𝘱(e,o)local i,a,d=𝘣(n𝘢)local n=l(nv)return e==nv and i~=nil and mget(n.cellx+nx+a,n.celly+t+d)==o end function 𝘲(e)local n,o,i=𝘣(n𝘢)local n=l(nv)mset(n.cellx+nx+o,n.celly+t+i,e)end function 𝘥(e,o,n,l)return n𝘲==e and nv==o and(n==nil or n==nx and l==t)end function k(n)local e=split(n)if(nv~=e[1])return false
...
end 𝘬(l[e],n[t+1])end end function 𝘬(n,e)n.intent="walk"n.intentdata=e end function nm()music"-1"n𝘵="playmap"n𝘤="g"n𝘧=1v"1"n_={}𝘵("woods1",8,8)nj={{charid="w",mapid="woods1",x=nx,y=t},{charid="k",mapid="woods1",x=nx,y=t}}pal(14,14,1)pal(15,15,1)pal(12,12,1)pal(1,1,1)pal(8,8,1)end function n8(n,e,o,t)n.x=o n.y=t n.mapid=e local e=split(n.intentdata,"|")if(n.intent=="walk"and#e>2)n.intentdata=e[3].."|"..e[4]
...
local e=63-2*#n.title n𝘹={x=e,y=12,txt=n.title,frmcnt=45}local e,t=n.cellx,n.celly if not o(n𝘸,nv)then local a=nk()for n=0,15do for l=0,15do local i=mget(n+e,l+t)if(o(a,i))local o=n6(i)local i=z(o)mset(n+e,l+t,o[i])
end end add(n𝘸,nv)end for n in all(n𝘯)do if n.type=="interior"and n.playmapid==nv then local e,o,n=n.playmaplocx+e,n.playmaplocy+t,n.playmapspr mset(e,o,n)if(n~=218)mset(e+1,o,n+1)mset(e,o+1,n+16)mset(e+1,o+1,n+17)
...
end return na end function 𝘮(n,e,o,l)g(e,o,#n*4+8,12,4,10,9)local t=0if(l)t=10b(n,e+5,o+5,2)
b(n,e+4,o+4,t)end function 𝘦()return nl(nj,nz)end function nl(e,o)local n={}for e in all(e)do add(n,e)end for e in all(o)do add(n,e)end return n end function n7(n)if(n.time==nil)n.time=1
g(8,100,112,24,4,10,9)local l=n.speakerid local i=y(h(l=="*",n𝘤,l))local e,t,a=i.name,n.text,n.time print(e,30,104,2)print(e,29,103,9)local e=t if(l=="𝘢"and a==1)sfx(4)
if(a<#t)e=sub(t,1,a)n.time+=1
if#e<=22then b(e,29,110,0)else local n=-1for t=23,1,-1do if(o(split(",.? ",""),sub(e,t,t)))n=t break
end b(sub(e,1,n).."\n"..sub(e,n+1),29,110,0)end g(10,103,17,17,1,6,5)spr(i.chrsprdailogueidx,11,104,2,2)if(n.large)g(30,22,68,68,1,6,5)𝘺(0,i.chrsprdailogueidx,4,3,4,false,false,16)
local n,o=117,2if(#t==#e)n,o=117,10
if(btn(5))n,o=118,9
if(n==117)print("❎",112,118,0)
print("❎",112,n,o)end function 𝘣(n)if(n==nil)return nil
